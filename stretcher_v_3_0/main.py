...
class Dialog(QDialog):
    ...
    def __init__(self):
        ...
        # self.ui.squareButton.clicked.connect(self.SignalSquare)
        # self.ui.sinusoidalButton.clicked.connect(self.SignalSinusoidal)
    ...
    #     self.ui.pauseButton.clicked.connect(self.Pause_Treatment)
        ...
        self.SignalDisableButton('triangular')
        self.SignalDisableButton('square')
        self.SignalDisableButton('sinusoidal')

        self.FrequencyDisableButton('freq1')
        self.FrequencyDisableButton('freq2')
        self.FrequencyDisableButton('freq3')
        self.FrequencyDisableButton('freq4')
        self.FrequencyDisableButton('freq5')
        self.FrequencyDisableButton('freq6')
    ...
    def SignalDisableButton(self, button):
