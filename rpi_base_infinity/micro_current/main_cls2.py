...
class MainWindow (QMainWindow):
    ...
    def __init__(self, distro, serialport, parent=None):
        ...
        # ch2 was acuscope ch4 was myopulse
        self.ch2_dummy = ChnlsDummy()
        self.ch4_dummy = ChnlsDummy()        
        ...
        self.gain_ui_list = [self.ui.ch1_gainLabel, self.ch2_dummy, 0, 0]        
        for x in range(2):
        ...
        self.pol_pos_ui_list = [self.ui.ch1_posButton, 0, self.ui.ch3_posButton, 0]        
        self.pol_alt_ui_list = [self.ui.ch1_altButton, 0, self.ui.ch3_altButton, 0]
        self.pol_neg_ui_list = [self.ui.ch1_negButton, 0, self.ui.ch3_negButton, 0]
        ...
        self.timer_ui_list = [self.ui.ch1_timerLabel, self.ch2_dummy, self.ui.ch3_timerLabel, self.ch4_dummy]
        for x in range(4):
        ...
        self.freq_ui_list = [self.ui.ch1_freqLabel, self.ch2_dummy, self.ui.ch3_freqLabel, self.ch4_dummy]
        for x in range(4):
        ...
        self.pwr_ui_list = [self.ui.ch1_pwrLabel, self.ch2_dummy, self.ui.ch3_pwrLabel, self.ch4_dummy]
        for x in range(4):
        ...
        ##
        self.startButton_ui_list = [self.ui.ch1_startButton, self.ch2_dummy, self.ui.ch3_startButton, self.ch4_dummy]
        self.stopButton_ui_list = [self.ui.ch1_stopButton, self.ch2_dummy, self.ui.ch3_stopButton, self.ch4_dummy]
        self.remainMins_ui_list = [self.ui.ch1_remainMinsLabel, self.ch2_dummy, self.ui.ch3_remainMinsLabel, self.ch4_dummy]
        self.remainSecs_ui_list = [self.ui.ch1_remainSecsLabel, self.ch2_dummy, self.ui.ch3_remainSecsLabel, self.ch4_dummy]
        # self.enableButton_ui_list = [self.ui.ch1_enableButton, self.ch2_dummy, self.ui.ch3_enableButton, self.ch4_dummy]
        ...
        self.displayLabel_ui_list = [self.ui.ch1_displayLabel, self.ch2_dummy, self.ui.ch3_displayLabel, self.ch4_dummy]
        for x in range(4):
            self.displayLabel_ui_list[x].setText('--')

        self.displayTextLabel_ui_list = [self.ui.ch1_displayTextLabel, self.ch2_dummy, self.ui.ch3_displayTextLabel, self.ch4_dummy]
        for x in range(4):
