...
class TreatmentDialog(QDialog):
    ...
    def SendStartNewSM (self):
        if self.init_state == 'clean':
            ...
            self.s.Write(to_send + "\r\n")
            self.InsertLocalText(to_send)
            self.init_state = 'check_ch1'
            self.init_timer.singleShot(100, self.SendStartNewSM)
            
        elif self.init_state == 'check_ch1':
            # check if ch1 is enabled or send disable
            ...
            self.s.Write(to_send + "\r\n")
            self.InsertLocalText(to_send)
            self.init_state = 'check_ch2'
            self.init_timer.singleShot(100, self.SendStartNewSM)

        elif self.init_state == 'check_ch2':
            # check if ch2 is enabled or send disable
            ...
            self.s.Write(to_send + "\r\n")
            self.InsertLocalText(to_send)
            self.init_state = 'check_ch3'
            self.init_timer.singleShot(100, self.SendStartNewSM)

        elif self.init_state == 'check_ch3':
            # check if ch3 is enabled or send disable
    ...
    # ERROR(0x054)\r on magnet; in stretcher ERROR(0x21)
    def ProcessErrorString(self, error_str):
        ...
        if error_channel.startswith('1') and self.antenna_ch1 == True:
            ...
            self.antenna_ch3 = False
            self.ui.ant1Button.setIcon(current_icon)
            self.ui.ant2Button.setIcon(disa_icon)
            self.ui.ant3Button.setIcon(disa_icon)            
        ...
        if error_channel.startswith('2') and self.antenna_ch2 == True:
            ...
            self.antenna_ch3 = False
            self.ui.ant2Button.setIcon(current_icon)
            self.ui.ant1Button.setIcon(disa_icon)
            self.ui.ant3Button.setIcon(disa_icon)            
