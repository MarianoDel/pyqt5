...
"border:3px solid rgb(55, 52, 53);")
        ...
        self.minutesLabel.setGeometry(QtCore.QRect(490, 675, 146, 71))
        font = QtGui.QFont()
        font.setFamily("Liberation Sans")
        ...
        self.powerLabel.setGeometry(QtCore.QRect(455, 520, 136, 81))
        font = QtGui.QFont()
        font.setFamily("Liberation Sans")
        font.setPointSize(56)
        font.setBold(True)
...
"border:3px solid rgb(55, 52, 53);")
        ...
        self.powerLabel_2 = QtWidgets.QLabel(StagesDialog)
        self.powerLabel_2.setGeometry(QtCore.QRect(585, 520, 76, 81))
        font = QtGui.QFont()
        font.setFamily("Liberation Sans")
        font.setPointSize(56)
        font.setBold(True)
        font.setWeight(75)
        self.powerLabel_2.setFont(font)
        self.powerLabel_2.setStyleSheet("color: rgb(237, 50, 55);")
        self.powerLabel_2.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.powerLabel_2.setObjectName("powerLabel_2")
        self.minutesLabel_2 = QtWidgets.QLabel(StagesDialog)
        self.minutesLabel_2.setGeometry(QtCore.QRect(635, 675, 21, 71))
        font = QtGui.QFont()
        font.setFamily("Liberation Sans")
        font.setPointSize(56)
        font.setBold(True)
        font.setWeight(75)
        self.minutesLabel_2.setFont(font)
        self.minutesLabel_2.setStyleSheet("color: rgb(62, 64, 149);")
        self.minutesLabel_2.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.minutesLabel_2.setObjectName("minutesLabel_2")
    ...
    def retranslateUi(self, StagesDialog):
        ...
        self.powerLabel_2.setText(_translate("StagesDialog", "%"))
        self.minutesLabel_2.setText(_translate("StagesDialog", "\'"))
